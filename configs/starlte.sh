...
cat ./BootShim/AARCH64/BootShim.bin "./Build/starltePkg-AARCH64/${_TARGET_BUILD_MODE}_CLANG38/FV/STARLTE_UEFI.fd" > ./ImageResources/bootpayload.bin||exit 1

python3 ./ImageResources/mkbootimg.py \
	--kernel ./ImageResources/bootpayload.bin \
	--ramdisk ./ImageResources/ramdisk \
	--dtb "./ImageResources/DTBs/starlte.dtb" \
